...
//   Future<void> exportDocumentToFirestore(
//       String documentName, Uint8List fileData, String userId) async {
//     final storageReference = FirebaseStorage.instance
//         .ref()
//         .child('documents/$userId/${documentName}$_selectedFormat');
...
//         .doc(userId)
//         .collection('files')
//         .doc('$documentName$_selectedFormat')
//         .set({
//       'name': documentName,
...
//                 if (user != null) {
//                   await exportDocumentToFirestore(
//                       documentName, fileData!, user.uid);
//                   Navigator.of(context).pop();
...
//                 final file =
//                     File('${directory.path}/$documentName$_selectedFormat');
...
//   // Ppt
//   Future<Uint8List> generatePptxDocument(String text) async {
//     final presentation = PowerPoint();
//     final slide = presentation.slides.add();
//     final title = slide.shapes.title;
//     title.text = text;

//     final pptxBytes = await presentation.save();
...
//   final docx.Template docxTemplate = docx.Template();

//   final Map<String, dynamic> context = {
//     'text': text,
//   };

//   final List<docx.Placeholder> placeholders = docxTemplate.placeholders();
//   for (final docx.Placeholder placeholder in placeholders) {
//     if (context.containsKey(placeholder.content)) {
//       placeholder.text = context[placeholder.content].toString();
//     }
//   }

//   return docxTemplate.save();
// }
// }
...
class _RecognizePageState extends State<RecognizePage> {
  ...
  //   final textRun = slide.shapes.addTextRun().setText(text);
  //   textRun.fontSize = 20;

  //   final bytes = presentation.saveAsStream();
  //   presentation.dispose();
  ...
  Future<Uint8List?> generateDocxDocument(String text) async {
    ...
    final path = '${directory?.path}/test2023.pptx';
    final file = File(path);
    print("Saving $path");
    await file.writeAsString("Simple word document from Flutter." );
...
Future<Uint8List?> generatePptxDocument(String text) async {
  ...
  //       Uri.parse('http://172.16.4.122:5000/generate_docx'),
  //       headers: headers,
  //       body: json.encode({'text': text}));
  //   // final response = await http.post(
  //   //   Uri.parse('http://http://127.0.0.1:5000/generate_docx'), // Replace with your actual server address
  //   //   body: {'text': text},
  //   // );
