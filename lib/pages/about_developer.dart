...
class _AboutDeveloperState extends State<AboutDeveloper> {
      ...
      body: Padding(
        ...
        child: ListView(
          ...
          children: [
            ...
            AppUtils.aboutDeveloperImageConWithDesc(
              imagePath: 'assets/images/Abdiwali.jpg'
            ),
            AppUtils.sizedBox(22.0, 0.0),
            AppUtils.aboutDeveloperImageConWithDesc(
                imagePath: 'assets/images/Abdulqadir.jpeg'
            ),
            AppUtils.sizedBox(22.0, 0.0),
            AppUtils.aboutDeveloperImageConWithDesc(
                imagePath: 'assets/images/Abdixafiid.jpeg'
            ),
            AppUtils.sizedBox(22.0, 0.0),
            AppUtils.aboutDeveloperImageConWithDesc(
                imagePath: 'assets/images/Yasac.jpeg'
            ),
            AppUtils.sizedBox(22.0, 0.0),
            AppUtils.aboutDeveloperImageConWithDesc(
                imagePath: 'assets/images/Mohamed.jpeg'
            ),
          ],
        ),
      ),
  ...
  final List<Widget> _demo = [
    AppUtils.aboutDeveloperImageCon(),
    AppUtils.aboutDeveloperImageCon(),
    AppUtils.aboutDeveloperImageCon(),
    AppUtils.aboutDeveloperImageCon(),
  ];
